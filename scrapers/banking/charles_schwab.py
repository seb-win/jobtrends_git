...
HEADERS = {
    ...
    'priority': 'u=1, i',
    'referer': 'https://www.schwabjobs.com/search-jobs',
...
DAILY_JOB_URL = 'https://www.schwabjobs.com/search-jobs/results'
...
def update_master_list_with_jobs(all_jobs, master_list):
    ...
    for job in all_jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://www.schwabjobs.com/' + job.get('link')
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
