...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['jobsList']
TOTAL_JOBS_KEY = ['totalMatches']
...
HEADERS = {
    ...
    # 'Cookie': 'TS01812f07=0176872a9831b90911585c3cfa405197154fb930d6760a3e45ae6236491035030a679cba5737385bc391fe73f54facaa3527063785; JSESSIONID=node01mnbfm1afjfoo34sd1m69dlcr915311.node0; OptanonAlertBoxClosed=2025-01-03T22:15:59.869Z; utag_main=v_id:01942e3d4fc80014c33b1113930405075002706d00bd0$_sn:1$_se:2$_ss:0$_st:1735944363439$ses_id:1735942557640%3Bexp-session$_pn:2%3Bexp-session; OptanonConsent=isGpcEnabled=0&datestamp=Fri+Jan+03+2025+23%3A16%3A03+GMT%2B0100+(Mitteleurop%C3%A4ische+Normalzeit)&version=202409.2.0&browserGpcFlag=0&isIABGlobal=false&hosts=&consentId=4d766e66-95c7-4a48-87d0-9270ec02d83d&interactionCount=1&isAnonUser=1&landingPath=NotLandingPage&groups=CCBA%3A1%2CC0004%3A0%2CC0002%3A0%2CC0003%3A0%2CCADCA%3A0%2CC0001%3A1&intType=3&geolocation=DE%3BBY&AwaitingReconsent=false',
    'Referer': 'https://careers.bankofamerica.com/en-us/job-search?ref=search&start=0&rows=10&search=getAllJobs',
...
DAILY_JOB_URL = 'https://careers.bankofamerica.com/services/jobssearchservlet'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://careers.bankofamerica.com' + job.get('link')
