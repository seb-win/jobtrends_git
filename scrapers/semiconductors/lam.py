...
HEADERS = {
    ...
    'priority': 'u=1, i',
    'referer': 'https://careers.lamresearch.com/careers?start=0&pid=1099552704202&sort_by=timestamp',
...
DAILY_JOB_URL = 'https://careers.lamresearch.com/api/pcsx/search'
...
def format_creation_ts(creation_ts_raw):
    """Convert Lam creationTs values from seconds or milliseconds to UTC ISO."""
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://careers.lamresearch.com/api/pcsx/position_details'
            params = {
                'position_id': job_id,
                'domain': 'lamresearch.com',
                'hl': 'de',
