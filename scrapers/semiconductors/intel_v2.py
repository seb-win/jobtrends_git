...
DAILY_JOB_URL = 'https://intel.wd1.myworkdayjobs.com/wday/cxs/intel/External/jobs'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://intel.wd1.myworkdayjobs.com/wday/cxs/intel/External' + job.get('link')
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
