...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['docs']
TOTAL_JOBS_KEY = ['numFound']

HEADERS = {
    'accept': 'application/json, text/plain, */*',
    'accept-language': 'de-DE,de;q=0.9,en-US;q=0.8,en;q=0.7',
    'authorization': 'Bearer QzRNUIKyb-RcjpEqp9yYOxZXE77fzUfXA_rk.SFtDyF5HJGOy4h45LyGsRNXFo3zRRmazJDW56-SBj4QQ4__2wgiHVGA3qs_f5Xyy7xtXJ6D6c8tkb2ZdG1Z8tGW-PlYjnasjwbqoDgvlmpugEY5kGPLuDLCe5fmTW86V.YVQQmCqNfZkA1kWtonzoePXn2UklQGBznU5SAE4oibxsVO3p040KrVhMJEY78RPx1Rx4XqWRR4aHxrdnn1Ct3I',
    ...
    'x-correlation-id': '2f9c1e98-b96d-42e4-8755-cf683e1555c4',
}

DAILY_JOB_URL = 'https://gateway.mckinsey.com/apigw-x0cceuow60/v1/api/jobs/search'

JOB_DATA_KEYS = {
    'created': ['postedToLinkedInDate'],
    'jobTitle': ['title'],
    'department': ['industries'],
    'team': ['functions'],
    'jobArea': ['linkedInFunction'],
    ...
    'career_level': [],
    'employment_type': [],
    'salary': ['jobSalaryBenefits'],
    'compensationRange': ['compensationRange'],
    'compensationRangeCanada': ['compensationRangeCanada'][0],
    'jobDescription': ['whatYouWillDo'],
    'jobResponsibilities': ['whoYouWillWorkWith'],
    'jobRequirements': ['yourBackground'],
}
