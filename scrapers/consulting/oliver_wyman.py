...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['eagerLoadRefineSearch', 'data', 'jobs']
TOTAL_JOBS_KEY = ['eagerLoadRefineSearch', 'totalHits']

HEADERS = {
    'accept': '*/*',
    'accept-language': 'de-DE,de;q=0.9,en-US;q=0.8,en;q=0.7',
    'content-type': 'application/json',
    # 'cookie': 'osano_consentmanager_uuid=67645e70-d9c9-4b3f-8527-94b6d5400219; osano_consentmanager=OaCzX7Gc4mS90fEly5ds2QuoWLZtedC8ke7vLfoP-4uHXixyMYPp87iXap-bbzgnmdsya_5skAfeUgvURiDaYqCRrA0L4av2k3IoDoro_92W80sryRvwXBBk-1IkZsuVUGn4ZoEpjySHjo4mIEqZUMpenUsTECNUj3hUUknT7NbZRKTbf9PkXyotyLNmOTgxPUOmK9MVHTz7H68ohruSI2LOuEj7Cjr9-TFk8jFZkJeW7fUTV78WefK6hf23tsNPqQbM65nhjo7qyXhnz8nL_A6fvGK-3Cc8ZNa-ee6YvpoG5i9HZTCiIx61G8OVuwVe; VISITED_LANG=en; VISITED_COUNTRY=global; osano_consentmanager_uuid=a388c93d-03e0-4241-a86c-5ff696957329; osano_consentmanager=k-zpDJRYzWUTRVP5CJ20qnxUfZ6gKERTGhmHvXOAtybJxHndexwBB_bP_cajRJBWIU8tlHo6J70tDxkBMTcOUQjXpy6voPpRyOoTzGJv5dph40BJQn1uBsIOymZDvg15FIC0_GeTBDNE391WF_UKvqYpndbUgaUvSOs7nS4srqw0GXRq-HNg4Dp74HmTXlJLT632x4fpPvqiPCtR8FS-6OQ1K1Ns91jsSFw8XtGxTg-hYgDqu1aMeou-LNisGXBRxDk5Aw-8z9UlE__mv36FqY6SOrIo99LC1p9vNtETqoHVgU71t955wXfQ6BoJktqL; PLAY_SESSION=eyJhbGciOiJIUzI1NiJ9.eyJkYXRhIjp7IkpTRVNTSU9OSUQiOiIxNTJhZTJlNy05ZDQ0LTRhMTAtYjhmZi00N2U5NGViOGMyYzIifSwibmJmIjoxNzM1OTIzMjgyLCJpYXQiOjE3MzU5MjMyODJ9.dGSAMUxqR98inKn1HrdtsLZ6xoOt_Em0T2q90Ia_QDU; PHPPPE_ACT=152ae2e7-9d44-4a10-b8ff-47e94eb8c2c2; in_ref=https%3A%2F%2Fwww.oliverwyman.com%2F; ext_trk=pjid%3D152ae2e7-9d44-4a10-b8ff-47e94eb8c2c2&p_in_ref%3Dhttps://www.oliverwyman.com/&p_lang%3Den_global&refNum%3DMAMCGLOBAL; PHPPPE_GCC=d',
    'origin': 'https://careers.marshmclennan.com',
    'priority': 'u=1, i',
    'referer': 'https://careers.marshmclennan.com/global/en/oliver-wyman-search?from=10&s=1&rk=l-oliver-wyman-search',
    ...
    'x-csrf-token': '8fa333ffc3824b98826dc098112c341c',
}

DAILY_JOB_URL = 'https://careers.marshmclennan.com/widgets'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            start = job_link.find('/job')
            end = job_link.find('/apply')
            substring = job_link[start:end]
            job_link = 'https://mmc.wd1.myworkdayjobs.com/wday/cxs/mmc/MMC' + substring
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
