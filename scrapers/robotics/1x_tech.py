...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['pageProps', 'jobOffers']
TOTAL_JOBS_KEY = []
...
DAILY_JOB_URL = 'https://www.1x.tech/_next/data/ODEpvX_7tPEaq1n_c4Dfi/en/careers.json'

JOB_DATA_KEYS = {
    'created': [],
    'jobTitle': ['sharing_title'],
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://www.1x.tech/_next/data/ODEpvX_7tPEaq1n_c4Dfi/en/open-positions/' + job.get('link') + '.json'
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
                ...
                if response:
                    ...
                    job_text = json_text['pageProps']['job']['offer']
