...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['data', 'data']
TOTAL_JOBS_KEY = ['data', 'total_count']
...
HEADERS = {
    ...
    'priority': 'u=1, i',
    'referer': 'https://www.pfizer.com/about/careers/search-results?langcode=en&count=10&sort=latest',
...
DAILY_JOB_URL = 'https://www.pfizer.com/v1/api/workday/search'
...
JOB_DATA_KEYS = {
    ...
    'id': ['jobRequisitionId'],
    'link': [],
    'career_level': ['Job_Level'],
    'employment_type': ['jobType'],
    'salary': ['Compensation_Pay_Range'],
    'description': ['jobDescription'],
    'business_unit': ['pcfbizunitname']
}
...
def fetch_job_list_page(page):
    ...
    if page == PAGE_START:
        ...
        total_jobs = total_jobs * MAX_JOBS_PER_PAGE
