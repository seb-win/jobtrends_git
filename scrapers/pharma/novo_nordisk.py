...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['data', 'jobs']
TOTAL_JOBS_KEY = ['data', 'totalMatches']
...
HEADERS = {
    ...
    'authorization': '',
    'priority': 'u=1, i',
    'referer': 'https://www.novonordisk.com/careers/find-a-job/career-search-results.html?searchText=&countries=Denmark%3BUnited+States%3BChina+Mainland%3BAlbania%3BAlgeria%3BArgentina%3BAustralia%3BAustria%3BBelgium%3BBrazil%3BCanada%3BChile%3BColombia%3BEgypt%3BFrance%3BGermany%3BHong+Kong%3BIndia%3BIndonesia%3BIraq%3BIreland%3BIsrael%3BItaly%3BJapan%3BKuwait%3BMalaysia%3BMexico%3BPhilippines%3BPoland%3BRomania%3BSaudi+Arabia%3BSingapore%3BSouth+Africa%3BSouth+Korea%3BSweden%3BSwitzerland%3BTaiwan%3BThailand%3BTurkey%3BUkraine%3BUnited+Kingdom%3BVietnam&categories=Business+Development+%26+Strategy%3BBusiness+Support+%26+Administration%3BClinical+Development%3BCommercial+Marketing%3BCorporate+Affairs%3BData+%26+AI%3BDigital+%26+IT%3BEducation%3BEngineering+%26+Technical%3BFinance%3BHuman+Resource+Management%3BLegal%2C+Compliance+%26+Audit%3BManufacturing%3BMarket+Access%3BMedical+Affairs%3BProcurement%3BProject+Management+%26+Agile%3BQuality%3BReg+Affairs+%26+Safety+Pharmacovigilance%3BResearch%3BSupply+Chain%3BSales',
...
DAILY_JOB_URL = 'https://www.novonordisk.com/bin/nncorp/careersearch'

JOB_DATA_KEYS = {
    'created': [''],
    'jobTitle': ['jobTitle'],
    'department': ['jobCategory', 'label'],
    'team': ['jobSubCategory', 'label'],
    'location': ['jobCity', 'label'],
...
PARAMS = {
    'keyword': '',
    'country': 'Denmark;United States;China Mainland;Albania;Algeria;Argentina;Australia;Austria;Belgium;Brazil;Canada;Chile;Colombia;Egypt;France;Germany;Hong Kong;India;Indonesia;Iraq;Ireland;Israel;Italy;Japan;Kuwait;Malaysia;Mexico;Philippines;Poland;Romania;Saudi Arabia;Singapore;South Africa;South Korea;Sweden;Switzerland;Taiwan;Thailand;Turkey;Ukraine;United Kingdom;Vietnam',
    'category': 'Business Development & Strategy;Business Support & Administration;Clinical Development;Commercial Marketing;Corporate Affairs;Data & AI;Digital & IT;Education;Engineering & Technical;Finance;Human Resource Management;Legal, Compliance & Audit;Manufacturing;Market Access;Medical Affairs;Procurement;Project Management & Agile;Quality;Reg Affairs & Safety Pharmacovigilance;Research;Supply Chain;Sales',
    'locale': 'en',
}
JSON_PAYLOAD = None
DATA = None
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link =  'https://www.novonordisk.com/content/nncorp/global/en/careers/find-a-job/job-ad.' + job.get('id') + '.html'
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
                ...
                if response:
                    ...
                    html = soup.find('div', class_='career-search-wrapper')
                    job_text = html.get_text()
