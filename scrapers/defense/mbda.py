...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['data']
TOTAL_JOBS_KEY = ['paging', 'totalEntries']

HEADERS = {
    'accept': 'application/json, text/javascript, */*; q=0.01',
    'accept-language': 'de-DE,de;q=0.9,en-US;q=0.8,en;q=0.7',
    'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
    'origin': 'https://www.mbda-careers.de',
    'priority': 'u=1, i',
    'referer': 'https://www.mbda-careers.de/karriere/stellenangebote/?_order=ASC&_page=1',
...
DAILY_JOB_URL = 'https://www.mbda-careers.de/wp/wp-admin/admin-ajax.php'

JOB_DATA_KEYS = {
    'created': ['dummy_key'],
    'jobTitle': ['title', 'function'],
    'department': [],
    'team': ['title', 'focus'],
    'location': ['location'],
    'country': [],
...
def fetch_all_jobs():
    ...
    if USE_PAGINATION:
        ...
        while True:
            ...
            if total_jobs_from_response and len(all_jobs) >= int(total_jobs_from_response):
                break
        ...
        if existing_entry:
            ...
            if job_link:
                ...
                if response:
                    ...
                    job_text = soup.find('div', class_='grid-container').get_text()
