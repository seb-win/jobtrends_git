...
HEADERS = {
    ...
    'origin': 'https://hensoldt.wd3.myworkdayjobs.com',
    'priority': 'u=1, i',
    'referer': 'https://hensoldt.wd3.myworkdayjobs.com/de-DE/External_Career_Site/',
    ...
    'x-calypso-csrf-token': '731c06f8-b61d-411e-810a-2c94bbed4cf5',
}


DAILY_JOB_URL = 'https://hensoldt.wd3.myworkdayjobs.com/wday/cxs/hensoldt/External_Career_Site/jobs'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://hensoldt.wd3.myworkdayjobs.com/wday/cxs/hensoldt/External_Career_Site' + job.get('link')
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
