...
HEADERS = {
    ...
    'origin': 'https://stellen-kmw-group.kmweg.de',
    'priority': 'u=1, i',
    'referer': 'https://stellen-kmw-group.kmweg.de/',
...
DAILY_JOB_URL = 'https://searchui.search.windows.net/indexes/kmw-prod/docs/search'
...
JSON_PAYLOAD = {
    ...
    'facets': [
        'company,count:5000',
        'addresses/name,count:5000',
        'category,count:5000',
        'employmentType,count:5000',
    ],
    'filter': "datePosted lt 2025-02-25T21:34:41.040Z and (brand eq 'KMW')",
    'search': '*',
    'searchFields': 'jobId,title,profile,tasks',
    'skip': 0,
    'top': 500,
}
DATA = None
