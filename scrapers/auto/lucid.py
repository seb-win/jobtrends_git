...
HEADERS = {
    ...
    'if-none-match': 'W/"d159a7a094be79184461c2e599354e28"',
    'origin': 'https://lucidmotors.com',
    'priority': 'u=1, i',
    'referer': 'https://lucidmotors.com/',
...
DAILY_JOB_URL = 'https://boards-api.greenhouse.io/v1/boards/lucidmotors/departments'

JOB_DATA_KEYS = {
    'created': [],
    'jobTitle': ['title'],
    'department': ['metadata', 1, 'value'],
    'team': [],
        ...
        if existing_entry:
            ...
            if job_link:
                ...
                if response:
                    ...
                    title_text = soup.find('div', class_='job__title').get_text()
                    job_text = soup.find('div', class_='job__description body').get_text()
                    text = f'{title_text}\n{job_text}'
