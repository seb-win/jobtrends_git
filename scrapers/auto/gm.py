...
HEADERS = {
    ...
    'origin': 'https://generalmotors.wd5.myworkdayjobs.com',
    'priority': 'u=1, i',
...
DAILY_JOB_URL = 'https://generalmotors.wd5.myworkdayjobs.com/wday/cxs/generalmotors/Careers_GM/jobs'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://generalmotors.wd5.myworkdayjobs.com/wday/cxs/generalmotors/Careers_GM' + job.get('link')
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
