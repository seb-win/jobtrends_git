...
HEADERS = {
    ...
    'priority': 'u=1, i',
    'referer': 'https://ag.wd3.myworkdayjobs.com/de-DE/Airbus',
    ...
    'x-calypso-csrf-token': 'f7e1189c-8d7a-4aa7-bf22-c284a1cfad43',
}

DAILY_JOB_URL = 'https://ag.wd3.myworkdayjobs.com/wday/cxs/ag/Airbus/jobs'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://ag.wd3.myworkdayjobs.com/wday/cxs/ag/Airbus' + job_link
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
