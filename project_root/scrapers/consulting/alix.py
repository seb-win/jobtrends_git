...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['results', 0, 'hits']
TOTAL_JOBS_KEY = ['results', 0, 'nbHits']

HEADERS = {
    'Accept': '*/*',
    'Accept-Language': 'de-DE,de;q=0.9,en-US;q=0.8,en;q=0.7',
    'Connection': 'keep-alive',
    'Origin': 'https://www.alixpartners.com',
    'Referer': 'https://www.alixpartners.com/',
...
DATA = '{"requests":[{"indexName":"federated:published_alpha_asc","params":"analyticsTags=%5B%22web_desktop%22%5D&clickAnalytics=true&enableRules=false&facetFilters=%5B%5B%22facet%3ACareer%22%2C%22facet%3AJobs%22%5D%5D&facets=%5B%22culture%22%2C%22facet%22%2C%22filters.city%22%2C%22filters.country%22%2C%22filters.departmentTeam%22%2C%22filters.experienceLevel%22%5D&highlightPostTag=__%2Fais-highlight__&highlightPreTag=__ais-highlight__&hitsPerPage=500&ignorePlurals=true&maxValuesPerFacet=20&page=0&query=&queryLanguages=%5B%22en%22%5D&removeStopWords=true&ruleContexts=%5B%22Content%22%5D"},{"indexName":"federated:published_alpha_asc","params":"analytics=false&analyticsTags=%5B%22web_desktop%22%5D&clickAnalytics=false&enableRules=false&facets=facet&highlightPostTag=__%2Fais-highlight__&highlightPreTag=__ais-highlight__&hitsPerPage=0&ignorePlurals=true&maxValuesPerFacet=20&page=0&query=&queryLanguages=%5B%22en%22%5D&removeStopWords=true&ruleContexts=%5B%22Content%22%5D"}]}'

DAILY_JOB_URL = 'https://08nl1q16ge-dsn.algolia.net/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.20.0)%3B%20Browser%20(lite)%3B%20instantsearch.js%20(4.75.1)%3B%20Vue%20(3.4.21)%3B%20Vue%20InstantSearch%20(4.19.7)%3B%20JS%20Helper%20(3.22.5)&x-algolia-api-key=063aa389bd76152a6c03e5a937a5e475&x-algolia-application-id=08NL1Q16GE'

JOB_DATA_KEYS = {
    'created': ['dummy_key'],
    'jobTitle': ['_highlightResult', 'searchTile', 'title', 'value'],
    'department': ['searchTile', 'category'],
    'team': [],
    'location': ['searchTile', 'location'],
    'country': [],
    'contract': [],
    'id': ['searchTile', 'id'],
    'link': ['searchTile', 'link', 'url'],
    'career_level': [],
    'employment_type': [],
    'description': ['_highlightResult', 'content', 'value']
}
