...
HEADERS = {
    ...
    'origin': 'https://leonardocompany.wd3.myworkdayjobs.com',
    'priority': 'u=1, i',
    'referer': 'https://leonardocompany.wd3.myworkdayjobs.com/de-DE/LeonardoCareerSite',
    ...
    'x-calypso-csrf-token': 'ba991e09-3ffa-46a4-b884-208247f78d98',
}


DAILY_JOB_URL = 'https://leonardocompany.wd3.myworkdayjobs.com/wday/cxs/leonardocompany/LeonardoCareerSite/jobs'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://leonardocompany.wd3.myworkdayjobs.com/wday/cxs/leonardocompany/LeonardoCareerSite' + job.get('link')
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
