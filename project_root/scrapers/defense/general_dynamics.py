...
TOTAL_JOBS_KEY = ['ResultTotal']

HEADERS = {
    'accept': '*/*',
    'accept-language': 'de-DE,de;q=0.9,en-US;q=0.8,en;q=0.7',
    'api-auth-nonce': '4cf771a66a344af8b33371f079034fcb',
    'api-auth-signature': 'VX2hwNDZeVlJ8nxmeKat65uv4CcL8L0PVUs+yHRj0YQ=',
    'api-auth-timestamp': '2025-01-14T17:55:29.6582079Z',
    'priority': 'u=1, i',
...
DAILY_JOB_URL = 'https://www.gd.com/API/Careers/CareerSearch'
...
def encode_request(page: int) -> str:
    """
    Encodes the request parameter with adjustable page and pageSize.
    
    Args:
        page (int): The page number to encode.
        page_size (int): The number of items per page to encode.
...
def fetch_job_list_page(page):
    ...
    params = {**PARAMS}
    params['request'] = encode_request(page)
