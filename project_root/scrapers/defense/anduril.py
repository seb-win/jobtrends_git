...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['jobs']
TOTAL_JOBS_KEY = ['meta', 'total']

HEADERS = {
    'accept': '*/*',
    'accept-language': 'de-DE,de;q=0.9,en-US;q=0.8,en;q=0.7',
    'origin': 'https://www.anduril.com',
    'priority': 'u=1, i',
    'referer': 'https://www.anduril.com/',
...
DAILY_JOB_URL = 'https://boards-api.greenhouse.io/v1/boards/andurilindustries/jobs'

JOB_DATA_KEYS = {
    'created': ['dummy_key'],
    'jobTitle': ['title'],
    'department': ['metadata', 0, 'value'],
    'team': ['departments', 0, 'name'],
