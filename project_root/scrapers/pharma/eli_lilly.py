...
HEADERS = {
    ...
    'priority': 'u=1, i',
    'referer': 'https://careers.lilly.com/us/en/search-results?keywords=&from=0&s=1',
    ...
    'x-csrf-token': '08cd66556d884c408bf905bd70972157',
}

DAILY_JOB_URL = 'https://careers.lilly.com/widgets'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = cleaned_url = re.sub(r'/apply$', '', apply_link)
