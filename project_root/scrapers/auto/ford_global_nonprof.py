...
FOLDER_NAME = 'ford_global_nonprof'
...
HEADERS = {
    ...
    'Ora-Irc-Language': 'en',
    'Referer': 'https://efds.fa.em5.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1/requisitions?keyword=Hourly+team+member&mode=location',
