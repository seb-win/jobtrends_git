...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['searchResults']
TOTAL_JOBS_KEY = ['totalHits']
...
DAILY_JOB_URL = 'https://jobsapi-google.m-cloud.io/api/job/search?&pageSize=100&offset=0&companyName=companies%2F16115603-6c1b-4c45-b544-238a4e6c51b3&orderBy=posting_publish_time%20desc&queryLanguageCode=en-US&customAttributeFilter=ref!%3D%221041571%22&disableSpellCheck=true&enableBroadening=true'

JOB_DATA_KEYS = {
    'created': ['job', 'open_date'],
    'jobTitle': ['job', 'title'],
    'department': ['job', 'parent_category'],
    'team': ['job', 'primary_category'],
...
def fetch_job_list_page(page):
    ...
    DAILY_JOB_URL = f'https://jobsapi-google.m-cloud.io/api/job/search?&pageSize=100&offset={MAX_JOBS_PER_PAGE*page}&companyName=companies%2F16115603-6c1b-4c45-b544-238a4e6c51b3&orderBy=posting_publish_time%20desc&queryLanguageCode=en-US&customAttributeFilter=ref!%3D%221041571%22&disableSpellCheck=true&enableBroadening=true'
