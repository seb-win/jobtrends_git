...
KEY_NAME = 'limit'
JOBS_LIST_KEY = ['hits', 'hits']
TOTAL_JOBS_KEY = ['hits', 'total', 'value']
...
JOB_DATA_KEYS = {
    'created': [],
    'jobTitle': ['_source', 'title'],
    'department': ['_source', 'field_keyword_08'],
    'team': [],
    'location': ['_source', 'field_keyword_19'],
    'country': [],
    'contract': [],
    'id': ['_id'],
    'link': ['_source', 'url'],
    'career_level': ['_source', 'field_keyword_18'],
    'employment_type': [],
}
