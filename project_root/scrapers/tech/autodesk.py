...
DAILY_JOB_URL = 'https://autodesk.wd1.myworkdayjobs.com/wday/cxs/autodesk/Ext/jobs'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://autodesk.wd1.myworkdayjobs.com/wday/cxs/autodesk/Ext' + job_link
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
