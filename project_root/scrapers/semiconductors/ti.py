...
HEADERS = {
    ...
    'referer': 'https://careers.ti.com/search-jobs/',
...
DAILY_JOB_URL = 'https://jobsapi-google.m-cloud.io/api/job/search'

JOB_DATA_KEYS = {
    'created': ['job', 'open_date'],
    'jobTitle': ['job', 'title'],
    'department': ['job', 'primary_category'],
    'team': ['job', 'department'],
...
PARAMS = {
    ...
    'pageSize': str(MAX_JOBS_PER_PAGE),
    'companyName': 'companies/98e0e5c2-f5a0-4916-8894-cacc95da240a',
...
def fetch_job_list_page(page):
    ...
    try:
        ...
        jsonp_cleaned = jsonp_data[jsonp_data.find("(") + 1:jsonp_data.rfind(")")]
        job_data = json.loads(jsonp_cleaned)
