...
HEADERS = {
    ...
    # 'cookie': 'wd-browser-id=313ca753-784e-43a4-bfc4-d826e41b3bf5; CALYPSO_CSRF_TOKEN=7dbebe6f-3692-4808-9cd4-3893f9f78ca1; PLAY_SESSION=28208fc16b151e50ff2fb8f6fb74e0dc115b0805-analogdevices_pSessionId=2k5fuhb99q954uqmrk0eaua7dc&instance=vps-prod-d17kn7th.prod-vps.pr502.cust.ash.wd; wday_vps_cookie=2608429066.53810.0000; __cf_bm=gcgGYQkXZ23c8xxTV3aW_LkHVZlklvjssFdGW58Xyas-1735829976-1.0.1.1-K50TFW.TA7LVwrtee1Y7PSXWX1xyW7PpH4hLEpSCr9fuLbXmuu92O.tcL4.ZdYXqPVDr7XLQqb5YRbfP1ItUTw; __cflb=02DiuEyZJzFVW6zKk23ddk9h3x7TomPC2qqPTkf9Nwgpc; _cfuvid=Kry8cb9f9WHDEslV054nTms9Vhob5TihBGbhBx09Z50-1735829976781-0.0.1.1-604800000; timezoneOffset=-60',
    ...
    'x-calypso-csrf-token': '7dbebe6f-3692-4808-9cd4-3893f9f78ca1',
}

DAILY_JOB_URL = 'https://analogdevices.wd1.myworkdayjobs.com/wday/cxs/analogdevices/External/jobs'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://analogdevices.wd1.myworkdayjobs.com/wday/cxs/analogdevices/External' + job.get('link')
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
