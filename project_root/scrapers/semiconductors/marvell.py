...
HEADERS = {
    ...
    # 'cookie': 'wd-browser-id=d6f713a4-fc03-48ab-842f-4355ee3c8187; CALYPSO_CSRF_TOKEN=9d69afcd-5770-400e-819c-61936b8a4c9f; PLAY_SESSION=ac4bb288eb51929d781142f60a85f861ef14966b-marvell_pSessionId=127ioj4d61j6hiv6921usdp5ne&instance=vps-prod-t15dxdh7.prod-vps.pr502.cust.ash.wd; wday_vps_cookie=3430512650.53810.0000; __cf_bm=pmO9ix706VHTvtiATyJ4ZfQuD8si0PvqV8SXISP3N_o-1735840173-1.0.1.1-PV_vLGSxUhXWqOO584RBlTaQatr4.hH7GtwYPZdbAlyrtDhvogp4Tl0hXo9MFpwMyiPSl_4LG78JzKstiF24Iw; __cflb=02DiuEyZJzFVW6zKk23dzrfyh8dkkAVvMZ6nyKUi8WhvC; _cfuvid=4mlQ64wwTd1bPJIB4_fAEMK.XxvzhEAGfET6KZwQMHY-1735840173138-0.0.1.1-604800000; timezoneOffset=-60; _ga=GA1.4.1589154050.1735840176; _ga_WRM91MLPVT=GS1.4.1735840175.1.0.1735840295.60.0.0',
    'origin': 'https://marvell.wd1.myworkdayjobs.com',
    'priority': 'u=1, i',
    'referer': 'https://marvell.wd1.myworkdayjobs.com/MarvellCareers',
    ...
    'x-calypso-csrf-token': '9d69afcd-5770-400e-819c-61936b8a4c9f',
}

DAILY_JOB_URL = 'https://marvell.wd1.myworkdayjobs.com/wday/cxs/marvell/MarvellCareers/jobs'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://marvell.wd1.myworkdayjobs.com/wday/cxs/marvell/MarvellCareers' + job.get('link')
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
