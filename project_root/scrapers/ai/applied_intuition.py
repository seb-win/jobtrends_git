...
HEADERS = {
    ...
    'origin': 'https://www.appliedintuition.com',
    'priority': 'u=1, i',
    'referer': 'https://www.appliedintuition.com/',
...
DAILY_JOB_URL = 'https://boards-api.greenhouse.io/v1/boards/appliedintuition/departments'
