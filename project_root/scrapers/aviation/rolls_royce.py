...
HEADERS = {
    ...
    'priority': 'u=1, i',
    'referer': 'https://rollsroyce.wd3.myworkdayjobs.com/professional',
    ...
    'x-calypso-csrf-token': 'ad299353-0256-4ee3-b532-dc1acab768a4',
}

DAILY_JOB_URL = 'https://rollsroyce.wd3.myworkdayjobs.com/wday/cxs/rollsroyce/professional/jobs'
...
def update_master_list_with_jobs(jobs, master_list):
    ...
    for job in jobs:
        ...
        if existing_entry:
            ...
            job_link = 'https://rollsroyce.wd3.myworkdayjobs.com/wday/cxs/rollsroyce/professional' + job_link
            if job_link:
                response = fetch_url(
                    job_link,
                    headers=HEADERS,
