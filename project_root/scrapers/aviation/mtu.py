...
HEADERS = {
    ...
    'Origin': 'https://www.mtu.de',
    'Referer': 'https://www.mtu.de/careers/online-job-market/',
...
DAILY_JOB_URL = 'https://www.mtu.de/typo3temp/tx_bgmdvinci/285781-list.json'

JOB_DATA_KEYS = {
    'created': ['jobOpening', 'createdDate'],
    'jobTitle': ['jobOpening', 'name'],
    'department': ['categories', 0, 'name'],
    'team': [],
    'location': ['jobOpening', 'location'],
    'country': ['jobOpening', 'locations', 'country', 'name'],
    'contract': [],
    'id': ['id'],
    'link': ['jobPublicationURL'],
    'career_level': ['jobOpening', 'targetGroups', 0, 'name'],
    'employment_type': ['jobOpening', 'workingTimes', 0, 'name'],
    'company': ['jobOpening', 'company', 'name']
}
...
JSON_PAYLOAD = None
DATA = '{"l":"https://www.mtu.de/careers/online-job-market/","c":{"data":{"language":"en","url":"/typo3temp/tx_bgmdvinci/285781-list.json"},"ui":{"theme":"default-list-v2","jobsPerPage":20,"showEmptyChoices":false,"linkTarget":"_blank","sort":{"by":"date","order":"desc"},"showLabels":true,"showIcons":false,"lazyLoading":true,"flagAsNew":5,"flagAsNewEnabled":true},"cardContent":{"categories":{"enabled":true},"locations":{"enabled":true},"targetGroups":{"enabled":false},"workingTimes":{"enabled":false},"contractPeriod":{"enabled":false},"earliestEntryDate":{"enabled":false},"company":{"enabled":true},"orgUnit":{"enabled":false},"salaryRange":{"enabled":false}},"styles":{"brandColor":"#003963","fontSize":"14px","labelStyle":{"fontSize":"16px"},"headlineStyle":{"fontSize":"20px"},"inputStyle":{},"cardStyle":{}},"filters":{"maps":{"enabled":false,"hidden":false,"selected":[],"allowed":[]},"keywords":{"enabled":true,"hidden":false,"selected":[],"allowed":[],"order":1},"orgUnits":{"enabled":false,"hidden":false,"selected":[],"allowed":[]},"companies":{"enabled":false,"hidden":false,"selected":[],"allowed":[]},"categories":{"enabled":true,"hidden":false,"selected":[],"allowed":[],"order":2},"locations":{"enabled":true,"hidden":false,"selected":[],"allowed":[],"order":4},"targetGroups":{"enabled":true,"hidden":false,"selected":[],"allowed":[],"order":4},"languages":{"enabled":false,"hidden":false,"selected":[],"allowed":[]}},"i18n":{"messages":{}},"api":{"maps":{"requireConsent":false}}},"v":2,"w":{"class":"dvinci-job-widget","id":"dvinci-job-widget","data-url":"/typo3temp/tx_bgmdvinci/285781-list.json","data-list-jobs-per-page":"20","lang":"en","data-theme":"default-list-v2","data-filter-keyword-enabled":"true","data-style-brand-color":"#003963","data-style-headline-font-size":"20px","data-style-label-font-size":"16px","data-style-font-size":"14px","data-filter-keyword-order":"1","data-filter-category-order":"2","data-filter-location-order":"4","data-filter-targetgroup-order":"4"}}'
