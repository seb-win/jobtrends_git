...
DETAIL_MAPPING_V01 = {
    ...
    "dom": {
        "root_selector": "div.cmp-container.jobdescription",
        "fields": {
            "fulltext": {"selector": "div.grp-jobdescription__content.text", "mode": "html"},
            "overview": {"selector": "div.grp-jobdescription__content.text div.cmp-text:not([itemprop])", "mode": "text"},
        ...
        "remove_selectors": [
            "div.grp-jobdescription__apply",
            "div.grp-sharelinks",
            "div.grp-jobdescription__bottom",
            "div.grp-jobdescription__image-container",
            "button.grp-jobdescription__print",
            "button.grp-jobdescription__favorite",
        ],
    },
}
...
def extract_detail_sections(
    *,
    ...
    # -------- JSON --------
    if input_type == "json" and isinstance(raw, dict):
        try:
            raw = json.loads(raw)
        except Exception:
